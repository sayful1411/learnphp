...
/**
 * =========================
 * My Note: Date Function
 * =========================
 */
date_default_timezone_set('Asia/Dhaka');
// Day
//echo date("d"); // day ex. 21
//echo date("D"); // day letter ex. Tue
//echo date("l"); // full day name ex. Tuesday
// Month
//echo date("F"); // full month name ex. February
//echo date("m"); // month number ex. 02
//echo date("M"); // month letter ex. Feb
//echo date("n"); // month number ex. 2
// Year
//echo date("Y"); // full year ex. 2023
//echo date("y"); // year last 2 digit ex. 23
// Time
//echo date("a"); // small letter am/pm;
//echo date("A"); // upper letter am/pm;
//echo date("g"); // 12 hour format without zero ex. 04
//echo date("G"); // 24 hour format without zero ex. 4
//echo date("h"); // 12 hour format ex. 04
//echo date("H"); // 24 hour format ex. 04
//echo date("i"); // minutes ex. 20
//echo date("s"); // seconds ex. 01
// Most Common
...
/**
 * =====================
 * MY Note: Time Function
 * =====================
 */
//echo time(); // return current time into seconds
//echo strtotime("now"); // same 
//echo strtotime("10 September 2000"); // convert the specific date into seconds
// strtotime(); first parameter -> date time string 
// date() // first paremeter -> date time format | 2nd parameter -> timestamp
// timestamp -> strtotime(), mktime(), time()
/* $str = '15-3-2018'; // D-M-Y
if (($timestamp = strtotime($str)) === false) {
    echo "The string format ($str) is not currect";
} else {
